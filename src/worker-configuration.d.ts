/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: d8cd1b37791b82ff8158ba2fcce6caf5)
// Runtime types generated with workerd@1.20260801.1 2026-08-10 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	IMAGES_BUCKET: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	ADMIN_PASSWORD: "jimi-admin-2026!";
}
